 ...
 *   post:
 *     summary: Register a Firebase Cloud Messaging token for a User
 *     tags: [users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               token:
 *                 type: string
 *                 description: Firebase Cloud Messaging registration token generated by the mobile app
 *                 example: "fcm_device_token_example"
 *               platform:
 *                 type: string
 *                 enum: [android, ios, web]
 *                 description: Platform where the token was generated
 *                 example: "android"
 *     responses:
 *       200:
 *         description: FCM token registered
 *       400:
 *         description: Invalid User ObjectId
 *       401:
 *         description: Unauthorized
 *       403:
 *         description: Forbidden
 ...
 *         description: Validation failed (Joi)
 */
router.post('/:userId/fcm-token', authenticateToken, authorizeSelfOrAdmin, ValidateJoi(Schemas.User.fcmToken), controller.registerFcmToken);

/**
 * @openapi
 * /users/{userId}/fcm-token:
 *   delete:
 *     summary: Unregister a Firebase Cloud Messaging token from a User
 *     tags: [users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               token:
 *                 type: string
 *                 description: Firebase Cloud Messaging registration token to remove from the user
 *                 example: "fcm_device_token_example"
 *     responses:
 *       200:
 ...
 *         description: Validation failed (Joi)
 */
router.delete('/:userId/fcm-token', authenticateToken, authorizeSelfOrAdmin, ValidateJoi(Schemas.User.fcmTokenDelete), controller.unregisterFcmToken);
